# 1. Cria a pasta do domínio de prescrição
mkdir -p internal/domain/prescription

# 2. Cria o arquivo com as regras puras da entidade
cat > internal/domain/prescription/entity.go << 'EOF'
